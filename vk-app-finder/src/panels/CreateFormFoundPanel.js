...
import FoundStore from "../stores/FoundStore";

class CreateFormFoundPanel extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>
        ...
        <FormLayout separator="hide">
          <AddressInput title={'Местро находки'}
          ...
          <Textarea top="Описание"
                    ...
                    placeholder="Напишите все, что может помочь узнать найденного питомца"/>
...
export default observer(CreateFormFoundPanel);
